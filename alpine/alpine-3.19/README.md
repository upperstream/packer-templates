# Packer templates for Alpine Linux 3.19.2

Templates to create Vagrant boxes for Alpine Linux 3.19.2. (x86_64,
x86, and aarch64)
...
`Alpine-standard-3.19-x86_64-minimal-v19.2.20240618-virtualbox.box` in
the same directory after the command has succeeded.

Then you can add the box named
`Alpine-standard-3.19-x86_64-minimal-v19.2.20240618`
to your box list by the following command:

```
vagrant box add \
  Alpine-standard-3.19-x86_64-minimal-v19.2.20240618-virtualbox.box \
  --name Alpine-standard-3.19-x86_64-minimal-v19.2.20240618 \
  --provider virtualbox
```
...
You will find a vagrant box file named
`Alpine-standard-3.19-x86_64-minimal-v19.2.20240618-vmware.box` in the
same directory after the command has succeeded.

Then you can add the box named
`Alpine-standard-3.19-x86_64-minimal-v19.2.20240618` to your box list
by the following command:

```
vagrant box add \
  Alpine-standard-3.19-x86_64-minimal-v19.2.20240618-vmware.box \
  --name Alpine-standard-3.19-x86_64-minimal-v19.2.20240618 \
  --provider vmware
```
...
You will find a vagrant box file named
`Alpine-standard-3.19-x86_64-minimal-v19.2.20240618-libvirt.box` in the
same directory after the command has succeeded.
...
```
vagrant box add \
  Alpine-standard-3.19-x86_64-minimal-v19.2.20240618-libvirt.box \
  --name Alpine-standard-3.19-x86_64-minimal-v19.2.20240618 \
  --provider libvirt
```
...
You will find a vagrant box file named
`Alpine-standard-3.19-x86_64-minimal-v19.2.20240618-parallels.box` in
the same directory after the command has succeeded.
...
```
vagrant box add \
  Alpine-standard-3.19-x86_64-minimal-v19.2.20240618-parallels.box \
  --name Alpine-standard-3.19-x86_64-minimal-v19.2.20240618 \
  --provider parallels
```
...
You will find a vagrant box file named
`Alpine-standard-3.19-x86_64-minimal-v19.2.20240618-hyperv.box`
...
* `alpine-3.19-minimal.pkr.hcl` - Alpine Linux 3.19.2
* `alpine-3.19-docker.pkr.hcl` - Alpine Linux 3.19.2 with [Docker] +
  [Docker Compose]
* `alpine-3.16-dwm.pkr.hcl` - Alpine Linux 3.19.2 with [X.org][], [suckless][]
  tools, and [xrdp][].
* `alpine-3.16-xfce.pkr.hcl` - Alpine Linux 3.19.2 with [Xfce][] + [xrdp][].
