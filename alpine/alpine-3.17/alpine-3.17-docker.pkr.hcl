...
build {
  ...
  provisioner "shell" {
    environment_vars = [
      "DOCKER=docker=20.10.24-r2",
      "DOCKER_COMPOSE=docker-cli-compose=2.15.1-r3",
      "OS_VER=v${var.os_ver}",
      "PYTHON_PIP=py3-pip=22.3.1-r1",
      "PY_BCRYPT=py3-bcrypt=4.0.1-r0",
      "PY_CRYPTOGRAPHY=py3-cryptography=38.0.3-r1",
      "PY_PYNACL=py3-pynacl=1.5.0-r1",
      "SUDO_CMD=doas",
