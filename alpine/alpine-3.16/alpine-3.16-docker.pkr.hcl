...
build {
  ...
  provisioner "shell" {
    environment_vars = [
      "DOCKER=docker=20.10.20-r0",
      "DOCKER_COMPOSE=docker-cli-compose=2.12.2-r0",
      "OS_VER=v${var.os_ver}",
      "PYTHON_PIP=py3-pip=22.1.1-r0",
      "PY_BCRYPT=py3-bcrypt=3.2.2-r0",
      "PY_CRYPTOGRAPHY=py3-cryptography=3.4.8-r1",
      "PY_PYNACL=py3-pynacl=1.5.0-r0",
