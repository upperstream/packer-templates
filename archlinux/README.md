# Packer templates for Arch Linux 2026.02.01
...
You will find a vagrant box file named `ArchLinux-minimal-20260201.0-x86_64-virtualbox.box`
in the same directory after the command has succeeded.

Then you can add the box named `ArchLinux-minimal-20260201.0-x86_64`
 to your box list by the following command:

    vagrant box add ArchLinux-minimal-20260201.0-x86_64-virtualbox.box \
      --name ArchLinux-minimal-20260201.0-x86_64 --provider virtualbox
...
You will find a vagrant box file named `ArchLinux-minimal-20260201.0-x86_64-vmware.box`
in the same directory after the command has succeeded.

Then you can add the box named `ArchLinux-minimal-20260201.0-x86_64`
to your box list by the following command:

    vagrant box add ArchLinux-minimal-20260201.0-x86_64-vmware.box \
      --name ArchLinux-minimal-20260201.0-x86_64 --provider vmware_desktop
...
`ArchLinux-minimal-20260201.0-x86_64-libvirt.box` in the
same directory after the command has succeeded.

Then you can add the box named
`ArchLinux-minimal-20260201.0-x86_64`
to your box list by the following command:

    vagrant box add \
      ArchLinux-minimal-20260201.0-x86_64-libvirt.box \
      --name ArchLinux-minimal-20260201.0-x86_64 \
      --provider libvirt
...
You will find a vagrant box file named
`ArchLinux-minimal-20260201.0-x86_64-hyperv.box`
in the same directory after the command has succeeded.
...
Copyright &copy; 2017, 2018, 2024-2026 Upperstream.
