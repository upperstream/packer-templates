...
for p in PyYAML=3.11 ansible=2.0.0.2; do
  /tmp/python2tcz.sh $p
done
cat << EOF > /mnt/sda1/tce/optional/python-ansible-2.0.0.2.tcz.dep
...
tce-load -i python-ansible-2.0.0.2
echo "python-ansible-2.0.0.2" >> /mnt/sda1/tce/onboot.lst
