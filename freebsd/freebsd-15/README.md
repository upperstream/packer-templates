# Packer templates for FreeBSD 15.0-RELEASE

Templates to create Vagrant boxes for FreeBSD 15.0-RELEASE on ZFS root
...
`FreeBSD-15.0-RELEASE-minimal-v15.0.20251202-amd64` to your box list by
the following command:

    vagrant box add FreeBSD-15.0-RELEASE-minimal-v15.0.20251202-amd64-virtualbox.box --name FreeBSD-15.0-RELEASE-minimal-v15.0.20251202-amd64 --provider virtualbox
...
the following command:
    ...
    vagrant box add FreeBSD-15.0-RELEASE-minimal-v15.0.20251202-amd64-vmware.box --name FreeBSD-15.0-RELEASE-minimal-v15.0.20251202-amd64 --provider vmware_desktop
...
the following command:
    ...
    vagrant box add FreeBSD-15.0-RELEASE-minimal-v15.0.20251202-amd64-libvirt.box --name FreeBSD-15.0-RELEASE-minimal-v15.0.20251202-amd64 --provider libvirt
...
the following command:
    ...
    vagrant box add FreeBSD-15.0-RELEASE-minimal-v15.0.20251202-amd64-hyperv.box --name FreeBSD-15.0-RELEASE-minimal-v15.0.20251202-amd64 --provider hyperv
...
Then you can add the box named
`FreeBSD-15.0-RELEASE-minimal-v15.0.20251202-aarch64` to your box list
by the following command:

    vagrant box add FreeBSD-15.0-RELEASE-minimal-v15.0.20251202-aarch64-parallels.box --name FreeBSD-15.0-RELEASE-minimal-v15.0.20251202-aarch64 --provider parallels
...
* `virtualbox_netif` - Network interface for VirtualBox box.  Defaults to
  `em0`.
* `virtualbox_partition` - Disk name for VirtualBox box.  Defaults to
  `ada0`.
* `vm_name` - VM name.  This also affects box file name and output
  directory name. Defaults to `FreeBSD-15.0-RELEASE`.
