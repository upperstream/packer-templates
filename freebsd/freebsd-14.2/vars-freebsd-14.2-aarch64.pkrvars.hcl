...
iso_checksum = "file:https://download.freebsd.org/releases/ISO-IMAGES/14.2/CHECKSUM.SHA256-FreeBSD-14.2-BETA3-arm64-aarch64"
iso_name = "FreeBSD-14.2-BETA3-arm64-aarch64-disc1.iso"
