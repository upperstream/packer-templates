# Packer templates for FreeBSD 14.4-RC1

Templates to create Vagrant boxes for FreeBSD 14.4-RC1 on ZFS root file
system. (amd64, i386, and arm64)
...
`FreeBSD-14.4-RC-minimal-v1.20260228-amd64-virtualbox.box` in
the same directory after the command has succeeded.

Then you can add the box named
`FreeBSD-14.4-RC-minimal-v1.20260228-amd64-virtualbox` to your box list by
the following command:

    vagrant box add FreeBSD-14.4-RC-minimal-v1.20260228-amd64-virtualbox.box --name FreeBSD-14.4-RC-minimal-v1.20260228-amd64 --provider virtualbox
...
You will find a vagrant box file named
`FreeBSD-14.4-RC-minimal-v1.20260228-amd64-vmware.box` in the
same directory after the command has succeeded.

Then you can add the box named
`FreeBSD-14.4-RC-minimal-v1.20260228-amd64-vmware` to your box list by
the following command:

    vagrant box add FreeBSD-14.4-RC-minimal-v1.20260228-amd64-vmware.box --name FreeBSD-14.4-RC-minimal-v1.20260228-amd64 --provider vmware_desktop
...
You will find a vagrant box file named
`FreeBSD-14.4-RC-minimal-v1.20260228-amd64-libvirt.box` in the
same directory after the command has succeeded.

Then you can add the box named
`FreeBSD-14.4-RC-minimal-v1.20260228-amd64-libvirt` to your box list by
the following command:

    vagrant box add FreeBSD-14.4-RC-minimal-v1.20260228-amd64-libvirt.box --name FreeBSD-14.4-RC-minimal-v1.20260228-amd64 --provider libvirt
...
You will find a vagrant box file named
`FreeBSD-14.4-RC-minimal-v1.20260228-amd64-hyperv.box` in the
same directory after the command has succeeded.

Then you can add the box named
`FreeBSD-14.4-RC-minimal-v1.20260228-amd64-hyperv` to your box list by
the following command:

    vagrant box add FreeBSD-14.4-RC-minimal-v1.20260228-amd64-hyperv.box --name FreeBSD-14.4-RC-minimal-v1.20260228-amd64 --provider hyperv
...
You will find a vagrant box file named
`FreeBSD-14.4-RC-minimal-v1.20260228-aarch64-parallels.box` in the same
directory after the command has succeeded.

Then you can add the box named
`FreeBSD-14.4-RC-minimal-v1.20260228-aarch64-parallels` to your box list
by the following command:

    vagrant box add FreeBSD-14.4-RC-minimal-v1.20260228-aarch64-parallels.box --name FreeBSD-14.4-RC-minimal-v1.20260228-aarch64 --provider parallels
...
* `freebsd-14.4-minimal.pkr.hcl` - FreeBSD 14.4-RC1
* `freebsd-14.4-dwm.pkr.hcl` - FreeBSD 14.4-RC1 + [X.Org][] +
  [dwm][] + [dmenu][] + [st][]
* `freebsd-14.4-xfce.pkr.hcl` - FreeBSD 14.4-RC1 + [Xfce][] +
  [SLiM][]
...
* `vm_name` - VM name.  This also affects box file name and output
  directory name. Defaults to `FreeBSD-14.4-RC`.
