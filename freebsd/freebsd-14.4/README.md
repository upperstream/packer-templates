# Packer templates for FreeBSD 14.4-RELEASE

Templates to create Vagrant boxes for FreeBSD 14.4-RELEASE on ZFS root
...
From the terminal, invoke the following command for VirtualBox provider:
    ...
    packer build -only=virtualbox-iso.default freebsd-14.4-minimal.pkr.hcl

You will find a vagrant box file named
`FreeBSD-14.4-RELEASE-minimal-v14.4.20260310-amd64-virtualbox.box` in
the same directory after the command has succeeded.

Then you can add the box named
`FreeBSD-14.4-RELEASE-minimal-v14.4.20260310-amd64-virtualbox` to your
box list by the following command:

    vagrant box add FreeBSD-14.4-RELEASE-minimal-v14.4.20260310-amd64-virtualbox.box \
      --name FreeBSD-14.4-RELEASE-minimal-v14.4.20260310-amd64 --provider virtualbox
...
From the terminal, invoke the following command for VMware provider:
    ...
    packer build -only=vmware-iso.default freebsd-14.4-minimal.pkr.hcl

You will find a vagrant box file named
`FreeBSD-14.4-RELEASE-minimal-v14.4.20260310-amd64-vmware.box` in the
same directory after the command has succeeded.

Then you can add the box named
`FreeBSD-14.4-RELEASE-minimal-v14.4.20260310-amd64-vmware` to your box
list by the following command:

    vagrant box add FreeBSD-14.4-RELEASE-minimal-v14.4.20260310-amd64-vmware.box \
      --name FreeBSD-14.4-RELEASE-minimal-v14.4.20260310-amd64 --provider vmware_desktop
...
The following command will build a VM image on your ESXi:
    ...
    packer build -only=vmware-iso.esxi freebsd-14.4-minimal.pkr.hcl
...
feature by adding `-var esxi_vnc_over_websocket=false` parameter:
    ...
    packer build -only=vmware-iso.esxi -var esxi_vnc_over_websocket=false freebsd-14.4-minimal.pkr.hcl

### QEMU/libvirt

From the terminal, invoke the following command for Libvirt provider:

    packer build -only=qemu.default freebsd-14.4-minimal.pkr.hcl

You will find a vagrant box file named
`FreeBSD-14.4-RELEASE-minimal-v14.4.20260310-amd64-libvirt.box` in the
same directory after the command has succeeded.

Then you can add the box named
`FreeBSD-14.4-RELEASE-minimal-v14.4.20260310-amd64-libvirt` to your box
list by the following command:

    vagrant box add FreeBSD-14.4-RELEASE-minimal-v14.4.20260310-amd64-libvirt.box \
      --name FreeBSD-14.4-RELEASE-minimal-v14.4.20260310-amd64 --provider libvirt
...
From the terminal, invoke the following command for Hyper-V provider:
    ...
    packer build -only=hyperv-iso.default freebsd-14.4-minimal.pkr.hcl

You will find a vagrant box file named
`FreeBSD-14.4-RELEASE-minimal-v14.4.20260310-amd64-hyperv.box` in
the same directory after the command has succeeded.

Then you can add the box named
`FreeBSD-14.4-RELEASE-minimal-v14.4.20260310-amd64-hyperv` to your box list by
the following command:

    vagrant box add FreeBSD-14.4-RELEASE-minimal-v14.4.20260310-amd64-hyperv.box \
      --name FreeBSD-14.4-RELEASE-minimal-v14.4.20260310-amd64 --provider hyperv
...
From the terminal, invoke the following command for Parallels provider:
    ...
    packer build -only=parallels-iso.default -var-file vars-freebsd-14.4-aarch64.pkrvars.hcl freebsd-14.4-minimal.pkr.hcl

You will find a vagrant box file named
`FreeBSD-14.4-RELEASE-minimal-v14.4.20260310-aarch64-parallels.box` in
the same directory after the command has succeeded.

Then you can add the box named
`FreeBSD-14.4-RELEASE-minimal-v14.4.20260310-aarch64-parallels` to your
box list by the following command:

    vagrant box add FreeBSD-14.4-RELEASE-minimal-v14.4.20260310-aarch64-parallels.box \
      --name FreeBSD-14.4-RELEASE-minimal-v14.4.20260310-aarch64 --provider parallels
...
* `freebsd-14.4-minimal.pkr.hcl` - FreeBSD 14.4-RELEASE
* `freebsd-14.4-dwm.pkr.hcl` - FreeBSD 14.4-RELEASE + [X.Org][] +
  [dwm][] + [dmenu][] + [st][]
* `freebsd-14.4-xfce.pkr.hcl` - FreeBSD 14.4-RELEASE + [Xfce][] +
  [SLiM][]

While `freebsd-14.4-*.pkr.hcl` templates generate amd64 boxes by
default, using `vars-freebsd-14.4-aarch64.pkrvars.hcl` generates
aarch64 boxes:

    packer build -var-file=vars-freebsd-14.4-aarch64.pkrvars.hcl freebsd-14.4-minimal.pkr.hcl

and using `vars-freebsd-14.4-i386.pkrvars.hcl` generates i386
boxes:

    packer build -var-file=vars-freebsd-14.4-i386.pkrvars.hcl freebsd-14.4-minimal.pkr.hcl
...
[st]: http://st.suckless.org/ "st | suckless.org st - simple terminal"
...
* `vm_name` - VM name.  This also affects box file name and output
  directory name. Defaults to `FreeBSD-14.4-RELEASE`.
