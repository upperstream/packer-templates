# Packer templates for FreeBSD 14.1-RC1

Templates to create Vagrant boxes for FreeBSD 14.1-RC1 on ZFS root
...
`FreeBSD-14.1-RC-amd64-minimal-v1.20240526-virtualbox.box` in
the same directory after the command has succeeded.

Then you can add the box named
`FreeBSD-14.1-RC-amd64-minimal-v1.20240526` to your box list by
the following command:

    vagrant box add FreeBSD-14.1-RC-amd64-minimal-v1.20240526-virtualbox.box --name FreeBSD-14.1-RC-amd64-minimal-v1.20240526 --provider virtualbox
...
You will find a vagrant box file named
`FreeBSD-14.1-RC-amd64-minimal-v1.20240526-vmware.box` in the
...
the following command:
    ...
    vagrant box add FreeBSD-14.1-RC-amd64-minimal-v1.20240526-vmware.box --name FreeBSD-14.1-RC-amd64-minimal-v1.20240526 --provider vmware_desktop
...
You will find a vagrant box file named
`FreeBSD-14.1-RC-amd64-minimal-v1.20240526-libvirt.box` in the
same directory after the command has succeeded.
...
the following command:
    ...
    vagrant box add FreeBSD-14.1-RC-amd64-minimal-v1.20240526-libvirt.box --name FreeBSD-14.1-RC-amd64-minimal-v1.20240526 --provider libvirt
...
You will find a vagrant box file named
`FreeBSD-14.1-RC-amd64-minimal-v1.20240526-hyperv.box` in the
same directory after the command has succeeded.
...
the following command:
    ...
    vagrant box add FreeBSD-14.1-RC-amd64-minimal-v1.20240526-hyperv.box --name FreeBSD-14.1-RC-amd64-minimal-v1.20240526 --provider hyperv
...
You will find a vagrant box file named
`FreeBSD-14.1-RC-aarch64-minimal-v1.20240526-parallels.box` in the same
directory after the command has succeeded.

Then you can add the box named
`FreeBSD-14.1-RC-aarch64-minimal-v1.20240526` to your box list
by the following command:

    vagrant box add FreeBSD-14.1-RC-aarch64-minimal-v1.20240526-parallels.box --name FreeBSD-14.1-RC1-aarch64-minimal-v1.20240526 --provider parallels
...
* `freebsd-14.1-minimal.pkr.hcl` - FreeBSD 14.1-RC1
* `freebsd-14.1-dwm.pkr.hcl` - FreeBSD 14.1-RC1 + [X.Org][] +
  [dwm][] + [dmenu][] + [st][]
* `freebsd-14.1-xfce.pkr.hcl` - FreeBSD 14.1-RC1 + [Xfce][] +
  [SLiM][]
