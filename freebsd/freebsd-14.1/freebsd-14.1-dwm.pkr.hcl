...
variable "iso_checksum" {
  type    = string
  default = "file:https://download.freebsd.org/releases/ISO-IMAGES/14.1/CHECKSUM.SHA256-FreeBSD-14.1-RELEASE-amd64"
}
...
variable "path_to_iso" {
  type    = string
  default = "releases/ISO-IMAGES/14.1"
}
...
variable "vm_name" {
  type        = string
  default     = "FreeBSD-14.1-RELEASE-amd64"
