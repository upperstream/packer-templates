...
iso_checksum = "file:https://download.freebsd.org/releases/ISO-IMAGES/14.1/CHECKSUM.SHA256-FreeBSD-14.1-BETA3-arm64-aarch64"
iso_image = "FreeBSD-14.1-BETA3-arm64-aarch64-disc1.iso"
