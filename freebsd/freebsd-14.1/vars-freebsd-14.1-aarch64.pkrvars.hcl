...
iso_checksum = "file:https://download.freebsd.org/releases/ISO-IMAGES/14.1/CHECKSUM.SHA256-FreeBSD-14.1-RC1-arm64-aarch64"
iso_image = "FreeBSD-14.1-RC1-arm64-aarch64-disc1.iso"
ncurses_version = "6.4_1"
qemu_accelerator = "hvf"
qemu_binary = "qemu-system-aarch64"
qemu_machine_type = "virt"
virtualbox_guest_os_type = "FreeBSD"
vm_name = "FreeBSD-14.1-RC-aarch64"
