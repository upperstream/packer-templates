# Packer templates for FreeBSD 14.3-BETA4
...
the following command:
    ...
    vagrant box add FreeBSD-14.3-BETA-minimal-v4.20250524-virtualbox.box --name FreeBSD-14.3-BETA-minimal-v4.20250524 --provider virtualbox
