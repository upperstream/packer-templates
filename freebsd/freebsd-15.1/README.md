# Packer templates for FreeBSD 15.1-BETA2

Templates to create Vagrant boxes for FreeBSD 15.1-BETA2 on ZFS root
...
`FreeBSD-15.1-BETA-minimal-v2.20260508-amd64-virtualbox.box` in
the same directory after the command has succeeded.

Then you can add the box named
`FreeBSD-15.1-BETA-minimal-v2.20260508-amd64` to your box list by
the following command:

	vagrant box add FreeBSD-15.1-BETA-minimal-v2.20260508-amd64-virtualbox.box \
		--name FreeBSD-15.1-BETA-minimal-v2.20260508-amd64 \
		--provider virtualbox
...
You will find a vagrant box file named
`FreeBSD-15.1-BETA-minimal-v2.20260508-amd64-vmware.box` in the
...
the following command:
	...
	vagrant box add FreeBSD-15.1-BETA-minimal-v2.20260508-amd64-vmware.box \
		--name FreeBSD-15.1-BETA-minimal-v2.20260508-amd64 \
...
You will find a vagrant box file named
`FreeBSD-15.1-BETA-minimal-v2.20260508-amd64-libvirt.box` in the
same directory after the command has succeeded.
...
the following command:
	...
	vagrant box add FreeBSD-15.1-BETA-minimal-v2.20260508-amd64-libvirt.box \
		--name FreeBSD-15.1-BETA-minimal-v2.20260508-amd64 \
		--provider libvirt
...
You will find a vagrant box file named
`FreeBSD-15.1-BETA-minimal-v2.20260508-amd64-hyperv.box` in
the same directory after the command has succeeded.
...
the following command:
	...
	vagrant box add FreeBSD-15.1-BETA-minimal-v2.20260508-amd64-hyperv.box \
		--name FreeBSD-15.1-BETA-minimal-v2.20260508-amd64 \
		--provider hyperv
...
You will find a vagrant box file named
`FreeBSD-15.1-BETA-minimal-v2.20260508-aarch64-parallels.box` in the
same directory after the command has succeeded.

Then you can add the box named
`FreeBSD-15.1-BETA-minimal-v2.20260508-aarch64` to your box list
by the following command:

	vagrant box add FreeBSD-15.1-BETA-minimal-v2.20260508-aarch64-parallels.box \
		--name FreeBSD-15.1-BETA-minimal-v2.20260508-aarch64 \
		--provider parallels
...
You will find a vagrant box file named
`FreeBSD-15.1-BETA-minimal-v2.20260508-aarch64-utm.box` in the
same directory after the command has succeeded.
...
by the following command:
	...
	vagrant box add FreeBSD-15.1-BETA-minimal-v2.20260508-aarch64-utm.box \
		--name FreeBSD-15.1-BETA-minimal-v2.20260508-aarch64 \
		--provider utm
...
* `freebsd-15.1-minimal.pkr.hcl` - FreeBSD 15.1-BETA2
* `freebsd-15.1-dwm.pkr.hcl` - FreeBSD 15.1-BETA2 + [X.Org][] +
  [dwm][] + [dmenu][] + [st][]
* `freebsd-15.1-xfce.pkr.hcl` - FreeBSD 15.1-BETA2 + [Xfce][] +
  [SLiM][]
