# Packer templates for FreeBSD 15.1-RC1

Templates to create Vagrant boxes for FreeBSD 15.1-RC1 on ZFS root
...
`FreeBSD-15.1-RC-minimal-v1.20260523-amd64-virtualbox.box` in
...
the following command:
	...
	vagrant box add FreeBSD-15.1-RC-minimal-v1.20260523-amd64-virtualbox.box \
...
You will find a vagrant box file named
`FreeBSD-15.1-RC-minimal-v1.20260523-amd64-vmware.box` in the
...
the following command:
	...
	vagrant box add FreeBSD-15.1-RC-minimal-v1.20260523-amd64-vmware.box \
		--name FreeBSD-15.1-RC-minimal-v1.20260523-amd64 \
...
You will find a vagrant box file named
`FreeBSD-15.1-RC-minimal-v1.20260523-amd64-libvirt.box` in the
same directory after the command has succeeded.
...
the following command:
	...
	vagrant box add FreeBSD-15.1-RC-minimal-v1.20260523-amd64-libvirt.box \
		--name FreeBSD-15.1-RC-minimal-v1.20260523-amd64 \
		--provider libvirt
...
You will find a vagrant box file named
`FreeBSD-15.1-RC-minimal-v1.20260523-aarch64-parallels.box` in the
same directory after the command has succeeded.

Then you can add the box named
`FreeBSD-15.1-RC-minimal-v1.20260523-aarch64` to your box list
by the following command:

	vagrant box add FreeBSD-15.1-RC-minimal-v1.20260523-aarch64-parallels.box \
		--name FreeBSD-15.1-RC-minimal-v1.20260523-aarch64 \
		--provider parallels
...
You will find a vagrant box file named
`FreeBSD-15.1-RC-minimal-v1.20260523-aarch64-utm.box` in the
same directory after the command has succeeded.
...
by the following command:
	...
	vagrant box add FreeBSD-15.1-RC-minimal-v1.20260523-aarch64-utm.box \
		--name FreeBSD-15.1-RC-minimal-v1.20260523-aarch64 \
		--provider utm
...
* `freebsd-15.1-minimal.pkr.hcl` - FreeBSD 15.1-RC1
* `freebsd-15.1-dwm.pkr.hcl` - FreeBSD 15.1-RC1 + [X.Org][] +
  [dwm][] + [dmenu][] + [st][]
* `freebsd-15.1-xfce.pkr.hcl` - FreeBSD 15.1-RC1 + [Xfce][] +
  [SLiM][]
...
* `vm_name` - VM name.  This also affects box file name and output
  directory name. Defaults to `FreeBSD-15.1-RC`.
