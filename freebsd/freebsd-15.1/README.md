# Packer templates for FreeBSD 15.1-BETA3

Templates to create Vagrant boxes for FreeBSD 15.1-BETA3 on ZFS root
...
`FreeBSD-15.1-BETA-minimal-v3.20260516-amd64-virtualbox.box` in
the same directory after the command has succeeded.

Then you can add the box named
`FreeBSD-15.1-BETA-minimal-v3.20260516-amd64` to your box list by
the following command:

	vagrant box add FreeBSD-15.1-BETA-minimal-v3.20260516-amd64-virtualbox.box \
		--name FreeBSD-15.1-BETA-minimal-v3.20260516-amd64 \
		--provider virtualbox
...
You will find a vagrant box file named
`FreeBSD-15.1-BETA-minimal-v3.20260516-amd64-vmware.box` in the
...
the following command:
	...
	vagrant box add FreeBSD-15.1-BETA-minimal-v3.20260516-amd64-vmware.box \
		--name FreeBSD-15.1-BETA-minimal-v3.20260516-amd64 \
...
The following command will build a VM image on your ESXi:
	...
	packer build -only=vmware-iso.esxi freebsd-15.1-minimal.pkr.hcl
...
feature by adding `-var esxi_vnc_over_websocket=false` parameter:
	...
	packer build -only=vmware-iso.esxi \
		-var esxi_vnc_over_websocket=false freebsd-15.1-minimal.pkr.hcl
...
You will find a vagrant box file named
`FreeBSD-15.1-BETA-minimal-v3.20260516-amd64-libvirt.box` in the
same directory after the command has succeeded.
...
the following command:
	...
	vagrant box add FreeBSD-15.1-BETA-minimal-v3.20260516-amd64-libvirt.box \
		--name FreeBSD-15.1-BETA-minimal-v3.20260516-amd64 \
		--provider libvirt
...
QEMU build intends to create amd64 box.
...
You will find a vagrant box file named
`FreeBSD-15.1-BETA-minimal-v3.20260516-amd64-hyperv.box` in
the same directory after the command has succeeded.
...
the following command:
	...
	vagrant box add FreeBSD-15.1-BETA-minimal-v3.20260516-amd64-hyperv.box \
		--name FreeBSD-15.1-BETA-minimal-v3.20260516-amd64 \
		--provider hyperv
...
You will find a vagrant box file named
`FreeBSD-15.1-BETA-minimal-v3.20260516-aarch64-parallels.box` in the
same directory after the command has succeeded.

Then you can add the box named
`FreeBSD-15.1-BETA-minimal-v3.20260516-aarch64` to your box list
by the following command:

	vagrant box add FreeBSD-15.1-BETA-minimal-v3.20260516-aarch64-parallels.box \
		--name FreeBSD-15.1-BETA-minimal-v3.20260516-aarch64 \
		--provider parallels
...
You will find a vagrant box file named
`FreeBSD-15.1-BETA-minimal-v3.20260516-aarch64-utm.box` in the
same directory after the command has succeeded.
...
by the following command:
	...
	vagrant box add FreeBSD-15.1-BETA-minimal-v3.20260516-aarch64-utm.box \
		--name FreeBSD-15.1-BETA-minimal-v3.20260516-aarch64 \
		--provider utm
...
* `freebsd-15.1-minimal.pkr.hcl` - FreeBSD 15.1-BETA3
* `freebsd-15.1-dwm.pkr.hcl` - FreeBSD 15.1-BETA3 + [X.Org][] +
  [dwm][] + [dmenu][] + [st][]
* `freebsd-15.1-xfce.pkr.hcl` - FreeBSD 15.1-BETA3 + [Xfce][] +
  [SLiM][]

While `freebsd-15.1-*.pkr.hcl` templates generate amd64 boxes by
default, using `vars-freebsd-15.1-aarch64.pkrvars.hcl` generates
aarch64 boxes:

	packer build -var-file=vars-freebsd-15.1-aarch64.pkrvars.hcl \
		freebsd-15.1-minimal.pkr.hcl
...
* `vm_name` - VM name.  This also affects box file name and output
  directory name. Defaults to `FreeBSD-15.1-BETA`.
