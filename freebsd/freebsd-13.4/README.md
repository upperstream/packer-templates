# Packer templates for FreeBSD 13.4-RC1

Templates to create Vagrant boxes for FreeBSD 13.4-RC1 (amd64, i386, and arm64)
...
`FreeBSD-13.4-RC-amd64-minimal-v1.20240824-virtualbox.box` in
the same directory after the command has succeeded.

Then you can add the box named
`FreeBSD-13.4-RC-amd64-minimal-v1.20240824` to your box list by
the following command:

    vagrant box add FreeBSD-13.4-RC-amd64-minimal-v1.20240824-virtualbox.box --name FreeBSD-13.4-RC-amd64-minimal-v1.20240824 --provider virtualbox
...
You will find a vagrant box file named
`FreeBSD-13.4-RC1-amd64-v1.20240824-vmware.box` in the same
...
the following command:
    ...
    vagrant box add FreeBSD-13.4-RC-amd64-minimal-v1.20240824-vmware.box --name FreeBSD-13.4-RC-amd64-minimal-v1.20240824 --provider vmware_desktop
...
You will find a vagrant box file named
`FreeBSD-13.4-RC-amd64-minimal-v1.20240824-libvirt.box` in the same
directory after the command has succeeded.
...
the following command:
    ...
    vagrant box add FreeBSD-13.4-RC-amd64-minimal-v1.20240824-libvirt.box --name FreeBSD-13.4-RC-amd64-minimal-v1.20240824 --provider libvirt
...
You will find a vagrant box file named
`FreeBSD-13.4-RC-amd64-minimal-v1.20240824-hyperv.box` in the same
directory after the command has succeeded.
...
the following command:
    ...
    vagrant box add FreeBSD-13.4-RC-amd64-minimal-v1.20240824-hyperv.box --name FreeBSD-13.4-RC-amd64-minimal-v1.20240824 --provider hyperv
...
You will find a vagrant box file named
`FreeBSD-13.4-RC-aarch64-v1.20240824-parallels.box` in the same
directory after the command has succeeded.

Then you can add the box named
`FreeBSD-13.4-RC-aarch64-minimal-v1.20240824` to your box list
by the following command:

    vagrant box add FreeBSD-13.4-RC-aarch64-minimal-v1.20240824-hyperv.box --name FreeBSD-13.4-RC-aarch64-minimal-v1.20240824 --provider parallels
...
* `freebsd-13.4-minimal.pkr.hcl` - FreeBSD 13.4-RC1
* `freebsd-13.4-dwm.pkr.hcl` - FreeBSD 13.4-RC1 + [X.Org][] +
  [dwm][] + [dmenu][] + [st][]
* `freebsd-13.4-xfce.pkr.hcl` - FreeBSD 13.4-RC1 + [Xfce][] +
  [SLiM][]
* `freebsd-13.4-zfs.pkr.hcl` - FreeBSD 13.4-RC1 on ZFS root
  file system
