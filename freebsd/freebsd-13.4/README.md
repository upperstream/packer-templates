# Packer templates for FreeBSD 13.4-BETA3

Templates to create Vagrant boxes for FreeBSD 13.4-BETA3 (amd64, i386, and arm64)
...
`FreeBSD-13.4-BETA-amd64-minimal-v3.20240817-virtualbox.box` in
the same directory after the command has succeeded.

Then you can add the box named
`FreeBSD-13.4-BETA-amd64-minimal-v3.20240817` to your box list by
the following command:

    vagrant box add FreeBSD-13.4-BETA-amd64-minimal-v3.20240817-virtualbox.box --name FreeBSD-13.4-BETA-amd64-minimal-v3.20240817 --provider virtualbox
...
You will find a vagrant box file named
`FreeBSD-13.4-BETA3-amd64-v3.20240817-vmware.box` in the same
...
the following command:
    ...
    vagrant box add FreeBSD-13.4-BETA-amd64-minimal-v3.20240817-vmware.box --name FreeBSD-13.4-BETA-amd64-minimal-v3.20240817 --provider vmware_desktop
...
You will find a vagrant box file named
`FreeBSD-13.4-BETA-amd64-minimal-v3.20240817-libvirt.box` in the same
directory after the command has succeeded.
...
the following command:
    ...
    vagrant box add FreeBSD-13.4-BETA-amd64-minimal-v3.20240817-libvirt.box --name FreeBSD-13.4-BETA-amd64-minimal-v3.20240817 --provider libvirt
...
You will find a vagrant box file named
`FreeBSD-13.4-BETA-amd64-minimal-v3.20240817-hyperv.box` in the same
directory after the command has succeeded.
...
the following command:
    ...
    vagrant box add FreeBSD-13.4-BETA-amd64-minimal-v3.20240817-hyperv.box --name FreeBSD-13.4-BETA-amd64-minimal-v3.20240817 --provider hyperv
...
You will find a vagrant box file named
`FreeBSD-13.4-BETA-aarch64-v3.20240817-parallels.box` in the same
directory after the command has succeeded.

Then you can add the box named
`FreeBSD-13.4-BETA-aarch64-minimal-v3.20240817` to your box list
by the following command:

    vagrant box add FreeBSD-13.4-BETA-aarch64-minimal-v3.20240817-hyperv.box --name FreeBSD-13.4-BETA-aarch64-minimal-v3.20240817 --provider parallels
...
* `freebsd-13.4-minimal.pkr.hcl` - FreeBSD 13.4-BETA3
* `freebsd-13.4-dwm.pkr.hcl` - FreeBSD 13.4-BETA3 + [X.Org][] +
  [dwm][] + [dmenu][] + [st][]
* `freebsd-13.4-xfce.pkr.hcl` - FreeBSD 13.4-BETA3 + [Xfce][] +
  [SLiM][]
* `freebsd-13.4-zfs.pkr.hcl` - FreeBSD 13.4-BETA3 on ZFS root
  file system
