...
arch = "aarch64"
iso_name = "FreeBSD-13.5-BETA2-arm64-aarch64-disc1.iso"
iso_checksum = "file:https://download.freebsd.org/releases/ISO-IMAGES/13.5/CHECKSUM.SHA256-FreeBSD-13.5-BETA2-arm64-aarch64"
