# Packer templates for FreeBSD 13.5-BETA1

Templates to create Vagrant boxes for FreeBSD 13.5-BETA1 (amd64, i386, and arm64)
...
`FreeBSD-13.5-BETA-minimal-v1.20250207-amd64-virtualbox.box` in
the same directory after the command has succeeded.

Then you can add the box named
`FreeBSD-13.5-BETA-minimal-v1.20250207` to your box list by
the following command:

    vagrant box add FreeBSD-13.5-BETA-minimal-v1.20250207-amd64-virtualbox.box --name FreeBSD-13.5-BETA-minimal-v1.20250207 --provider virtualbox
...
You will find a vagrant box file named
`FreeBSD-13.5-BETA-v1.20250207-amd64-vmware.box` in the same
...
the following command:
    ...
    vagrant box add FreeBSD-13.5-BETA-minimal-v1.20250207-amd64-vmware.box --name FreeBSD-13.5-BETA-minimal-v1.20250207 --provider vmware_desktop
...
You will find a vagrant box file named
`FreeBSD-13.5-BETA-minimal-v1.20250207-amd64-libvirt.box` in the same
directory after the command has succeeded.
...
the following command:
    ...
    vagrant box add FreeBSD-13.5-BETA-minimal-v1.20250207-amd64-libvirt.box --name FreeBSD-13.5-BETA-minimal-v1.20250207 --provider libvirt
...
You will find a vagrant box file named
`FreeBSD-13.5-BETA-minimal-v1.20250207-amd64-hyperv.box` in the same
directory after the command has succeeded.
...
the following command:
    ...
    vagrant box add FreeBSD-13.5-BETA-minimal-v1.20250207-amd64-hyperv.box --name FreeBSD-13.5-BETA-minimal-v1.20250207 --provider hyperv
...
You will find a vagrant box file named
`FreeBSD-13.5-BETA-minimal-v1.20250207-aarch64-parallels.box` in the same
directory after the command has succeeded.

Then you can add the box named
`FreeBSD-13.5-BETA-minimal-v1.20250207` to your box list
by the following command:

    vagrant box add FreeBSD-13.5-BETA-minimal-v1.20250207-aarch64-parallels.box --name FreeBSD-13.5-BETA-minimal-v1.20250207 --provider parallels
...
* `freebsd-13.5-minimal.pkr.hcl` - FreeBSD 13.5-BETA1
* `freebsd-13.5-dwm.pkr.hcl` - FreeBSD 13.5-BETA1 + [X.Org][] +
  [dwm][] + [dmenu][] + [st][]
* `freebsd-13.5-xfce.pkr.hcl` - FreeBSD 13.5-BETA1 + [Xfce][] +
  [SLiM][]
* `freebsd-13.5-zfs.pkr.hcl` - FreeBSD 13.5-BETA1 on ZFS root
  file system
