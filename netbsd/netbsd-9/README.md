...
* `netbsd-9-minimal.pkr.hcl` - NetBSD 9.3
* `netbsd-9-xorg.pkr.hcl` - NetBSD 9.3 + [X.Org][]
* `netbsd-9-dwm.pkr.hcl` - NetBSD 9.3 + X.Org + [dwm][] + [st][] +
  [dmenu][], with [XDM] enabled
* `netbsd-9-xfce.pkr.hcl` - NetBSD 9.3 + [Xfce][], with XDM enabled
...
Copyright &copy; 2019-2021, 2023, 2024 Upperstream Software.
