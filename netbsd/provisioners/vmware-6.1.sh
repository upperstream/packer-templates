...
echo "Checking out anoncvs@anoncvs.NetBSD.org:/cvsroot with a tag \"pkgsrc-2015Q1\"."
...
pkg_add digest-20121220 libtool-base-2.4.2nb9 automake-1.15 pkg-config-0.28 libdnet-1.12nb1 icu-54.1nb2
