cpu = "arm64"
iso_checksum = "file:https://cdimages.ubuntu.com/ubuntu/releases/22.04.5/release/SHA256SUMS"
iso_name = "ubuntu-22.04.5-live-server-arm64.iso"
