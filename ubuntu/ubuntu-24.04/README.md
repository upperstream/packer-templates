# Packer templates for Ubuntu 24.04.4 LTS

Templates to create Vagrant boxes for Ubuntu 24.04.4 LTS (amd64 and
arm64).
...
`Ubuntu-24.04-minimal-v2404.4.20260212-amd64-virtualbox.box` in the
same directory after the command has succeeded.

Then you can add the box named `Ubuntu-24.04-minimal-v2404.4.20260212`
to your box list by the following command:

    vagrant box add Ubuntu-24.04-minimal-v2404.4.20260212-amd64-virtualbox.box \
      --name Ubuntu-24.04-minimal-v2404.4.20260212 --provider virtualbox
...
You will find a vagrant box file named
`Ubuntu-24.04-minimal-v2404.4.20260212-amd64-vmware.box` in the same
directory after the command has succeeded.

Then you can add the box named `Ubuntu-24.04-minimal-v2404.4.20260212`
to your box list by the following command:

    vagrant box add Ubuntu-24.04-minimal-v2404.4.20260212-amd64-vmware.box \
      --name Ubuntu-24.04-minimal-v2404.4.20260212 --provider vmware_desktop
...
You will find a vagrant box file named
`Ubuntu-24.04-minimal-v2404.4.20260212-amd64-libvirt.box` in the same
directory after the command has succeeded.

Then you can add the box named `Ubuntu-24.04-minimal-v2404.4.20260212`
to your box list by the following command:

    vagrant box add Ubuntu-24.04-minimal-v2404.4.20260212-amd64-libvirt.box \
      --name Ubuntu-24.04-minimal-v2404.4.20260212 --provider libvirt
...
You will find a vagrant box file named
`Ubuntu-24.04-minimal-v2404.4.20260212-amd64-hyperv.box` in the same
directory after the command has succeeded.

Then you can add the box named `Ubuntu-24.04-minimal-v2404.4.20260212`
to your box list by the following command:

    vagrant box add Ubuntu-24.04-minimal-v2404.4.20260212-amd64-hyperv.box \
      --name Ubuntu-24.04-minimal-v2404.4.20260212 --provider hyperv
...
You will find a vagrant box file named
`Ubuntu-24.04-minimal-v2404.4.20260212-arm64-parallels.box`
in the same directory after the command has succeeded.

Then you can add the box named `Ubuntu-24.04-minimal-v2404.4.20260212`
to your box list by the following command:

    vagrant box add Ubuntu-24.04-minimal-v2404.4.20260212-arm64-parallels.box \
      --name Ubuntu-24.04-minimal-v2404.4.20260212 --provider parallels

Parallels build intends to create arm64 box on Apple Silicon Mac host.

## Variants

* `ubuntu-24.04-minimal.pkr.hcl` - Ubuntu Server 24.04.4 LTS
* `ubuntu-24.04-dwm.pkr.hcl` - Ubuntu 24.04.4 LTS + [X.org][],
  [dwm][], [suckless][] tools, [ARandR][], and [xrdp][].
* `ubuntu-24.04-lxqt.pkr.hcl` - Ubuntu 24.04.4 LTS + [LXQt][]
* `ubuntu-24.04-xfce.pkr.hcl` - Ubuntu 24.04.4 LTS + [Xfce][]
...
While `ubuntu-24.04-*.pkr.hcl` templates use `ubuntu-24.04.4-live-server-amd64.iso`
ISO image to create amd64 boxes by default, using `vars-ubuntu-24.04-arm64.pkrvars.hcl`
creates arm64 boxes with `ubuntu-24.04.4-live-server-arm64.iso` ISO
image:
...
Copyright &copy; 2024, 2025, 2026 Upperstream.
