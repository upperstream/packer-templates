...
variable "iso_checksum" {
  type    = string
  default = "sha256:a1001736ed9fe2307965b5fcdb426ae11f9b80d26eb21e404a705144a0a224a0"
}

variable "iso_image" {
  type    = string
  default = "install74.iso"
}
...
source "hyperv-iso" "default" {
  boot_command     = split("\n", format(join("\n", local.boot_command), local.install_configs["with_x11"]))
