# Packer templates for OpenBSD 7.9

Templates to create Vagrant boxes for OpenBSD 7.9 (amd64, i386, and
arm64).
...
From the terminal, invoke the following command for VirtualBox provider:
    ...
    packer build -only=virtualbox-iso.default openbsd-7.9-minimal.pkr.hcl

You will find a vagrant box file named
`OpenBSD-7.9-minimal-v7.9.20260519-amd64-virtualbox.box` in the same
directory after the command has succeeded.

Then you can add the box named `OpenBSD-7.9-minimal-v7.9.20260519` to
your box list by the following command:

    vagrant box add OpenBSD-7.9-minimal-v7.9.20260519-amd64-virtualbox.box \
      --name OpenBSD-7.9-minimal-v7.9.20260519 --provider virtualbox
...
From the terminal, invoke the following command for VMware provider:
    ...
    packer build -only=vmware-iso.default openbsd-7.9-minimal.pkr.hcl

You will find a vagrant box file named
`OpenBSD-7.9-minimal-v7.9.20260519-amd64-vmware.box` in the same
directory after the command has succeeded.

Then you can add the box named `OpenBSD-7.9-minimal-v7.9.20260519` to
your box list by the following command:

    vagrant box add OpenBSD-7.9-minimal-v7.9.20260519-amd64-vmware.box \
      --name OpenBSD-7.9-minimal-v7.9.20260519 --provider vmware_desktop
...
The following command will build a VM image on your ESXi:
    ...
    packer build -only=vmware-iso.esxi openbsd-7.9-minimal.pkr.hcl
...
feature by adding `-var esxi_vnc_over_websocket=false` parameter:
    ...
    packer build -only=vmware-iso.esxi -var esxi_vnc_over_websocket=false openbsd-7.9-minimal.pkr.hcl

### QEMU/libvirt

From the terminal, invoke the following command for Libvirt provider:

    packer build -only=qemu.default openbsd-7.9-minimal.pkr.hcl

You will find a vagrant box file named
`OpenBSD-7.9-minimal-v7.9.20260519-amd64-libvirt.box` in the same
directory after the command has succeeded.

Then you can add the box named `OpenBSD-7.9-minimal-v7.9.20260519`
to your box list by the following command:

    vagrant box add OpenBSD-7.9-minimal-v7.9.20260519-amd64-libvirt.box \
      --name OpenBSD-7.9-minimal-v7.9.20260519 --provider libvirt
...
From the terminal, invoke the following command for Hyper-V provider:
    ...
    packer build -only=hyperv-iso.default openbsd-7.9-minimal.pkr.hcl

You will find a vagrant box file named
`OpenBSD-7.9-minimal-v7.9.20260519-amd64-hyperv.box` in the same
directory after the command has succeeded.

Then you can add the box named `OpenBSD-7.9-minimal-v7.9.20260519` to
your box list by the following command:

    vagrant box add OpenBSD-7.9-minimal-v7.9.20260519-amd64-hyperv.box \
      --name OpenBSD-7.9-minimal-v7.9.20260519 --provider hyperv
...
From the terminal, invoke the following command for Parallels provider:
    ...
    packer build -only=parallels-iso.default -var-file vars-openbsd-7.9-arm64.pkrvars.hcl openbsd-7.9-minimal.pkr.hcl

You will find a vagrant box file named
`OpenBSD-7.9-minimal-v7.9.20260519-arm64-parallels.box` in the same
directory after the command has succeeded.

Then you can add the box named `OpenBSD-7.9-minimal-v7.9.20260519` to
your box list by the following command:

    vagrant box add OpenBSD-7.9-minimal-v7.9.20260519-arm64-parallels.box \
...
* `openbsd-7.9-minimal.pkr.hcl` - OpenBSD 7.9
* `openbsd-7.9-x11.pkr.hcl` - OpenBSD 7.9 with [X11][]
* `openbsd-7.9-dwm.pkr.hcl` - OpenBSD 7.9 with X11 + [dwm][] +
  [dmenu][] + [st][] + Xenodm
* `openbsd-7.9-xfce.pkr.hcl` - OpenBSD 7.9 with [Xfce][] + Xenodm

While `openbsd-7.9-*.pkr.hcl` templates generate amd64 boxes by
default, using `vars-openbsd-7.9-arm64.pkrvars.hcl` generates arm64
boxes:

    packer build -var-file=vars-openbsd-7.9-arm64.pkrvars.hcl openbsd-7.9-minimal.pkr.hcl

and using `vars-openbsd-7.9-i386.pkrvars.hcl` generates i386 boxes:

    packer build -var-file=vars-openbsd-7.9-i386.pkrvars.hcl openbsd-7.9-minimal.pkr.hcl
