cpu = "arm64"
iso_name = "debian-12.0.0-arm64-netinst.iso"
iso_path = "12.0.0/arm64/iso-cd"
iso_checksum = "file:https://cdimage.debian.org/debian-cd/12.0.0/arm64/iso-cd/SHA256SUMS"
